    ...
    public struct CSSSelector {
        ...
        public init?(_ selector: String) {
            ...
            func getElement(_ string: inout String, cutMatchedSubstring: Bool = true) -> String? {
                ...
                /// ^([a-z0-9\*_-]+)((\|)([a-z0-9\*_-]+))?
                guard let result = firstMatch("^([a-z0-9\\*_-]+)((\\|)([a-z0-9\\*_-]+))?")(string) else {
                    return nil
                }
            ...
            func getAttribute(_ string: inout String, cutMatchedSubstring: Bool = true) -> String? {
                ...
                if let attributeWithExpression =
                    getAttributeWithExpression(&string, cutMatchedSubstring: cutMatchedSubstring) {
            ...
            // MARK: - Helper functions for regular expressions
